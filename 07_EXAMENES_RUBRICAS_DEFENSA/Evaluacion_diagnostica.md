...
tags: ["ai-academy", "evaluacion_rubrica", "transversal", "transversal"]
...
1. Explica qué diferencia hay entre prompt e instruction.
2. ¿Qué datos no deberías compartir con un modelo?
3. ¿Qué mirarías si una API devuelve 401?
4. ¿Qué es un webhook?
5. ¿Por qué medir tokens antes y después?
6. ¿Cuándo pondrías aprobación humana?
7. ¿Qué diferencia hay entre tool y skill?
8. ¿Qué es MCP?
---

# Desarrollo completo - Evaluacion Diagnostica

## Funcion dentro de la academia

Esta nota forma parte de la boveda de Obsidian de AI Professional Academy y debe leerse como material de estudio, no como un simple indice. Su funcion es desarrollar el tema Evaluacion diagnostica dentro del contexto de evaluacion, rubricas, diagnostico, defensa, criterios de calidad y evidencia de competencia. El objetivo es que el alumno pueda abrir este archivo, entender que papel ocupa en la formacion, estudiar el concepto con calma, practicarlo y despues convertirlo en una idea propia, un documento, una presentacion, un laboratorio o una pieza de un proyecto final.
...
Para Evaluacion diagnostica, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para Evaluacion diagnostica es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa AAAA+ - Evaluacion Diagnostica

## Proposito profesional de esta nota

Esta nota queda elevada al estandar AAAA+. Su funcion dentro de la boveda es servir como pieza profesional de evaluacion, rubrica, diagnostico, defensa y medicion de competencia real. No debe leerse como una nota aislada ni como un resumen rapido. Debe poder ayudar a un alumno a entender el tema, aplicarlo a su trabajo, convertirlo en proyecto, evaluarlo y defenderlo con criterio.
...
Dominio: evaluacion profesional.

Este archivo trabaja principalmente sobre: rubricas, diagnostico, defensa y evidencia.

El resultado esperado no es solo conocimiento. El resultado esperado es: evaluacion aplicable, criterios y feedback accionable.
...
# Capa ultra-premium AAAA+ - Evaluacion Diagnostica
...
Perfil principal al que sirve: evaluador, mentor y alumno en defensa.

Artefacto premium esperado: rubrica, diagnostico, defensa y feedback accionable.

Prueba de dominio: competencia demostrada con evidencia, no opinion.
...
Usar **Evaluacion diagnostica** para producir el entregable definido en la metadata: **rubrica o instrumento de evaluacion**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Evaluacion diagnostica**.
