...
Esta bóveda organiza la formación completa para construir una academia profesional de IA, automatización y agentes usando documentación oficial como fuente principal.

## Documento maestro

Empieza por [[../DOCUMENTO_MAESTRO|DOCUMENTO_MAESTRO]]. Es la guía principal de la bóveda: explica dónde está cada cosa, cómo se divide cada carpeta y cómo convertir estas notas en documentos, presentaciones, clases y proyectos.

## Cómo usar esta bóveda

1. Empieza por [[Mapa_de_la_formacion]] para entender la estructura.
2. Lee [[QUE_ES_CADA_CARPETA]] si algun nombre de carpeta te resulta confuso.
3. Revisa [[Ruta_150_Lecciones]] para ver el árbol pedagógico.
4. Usa `01_INVESTIGACION_OFICIAL` como base documental.
5. Usa `15_HERRAMIENTAS_OFICIALES_AVANZADAS` para elegir entre OpenAI, n8n, Gemini, Anthropic, Cursor, Hermes y Ollama.
6. Usa `04_CLASES_POR_HERRAMIENTA` para construir clases, documentos y presentaciones.
7. Usa `05_PRACTICAS_Y_EJERCICIOS` y `06_PROYECTOS_PARA_PORTFOLIO` para convertir teoría en práctica.
8. Usa `08_PLANTILLAS_REUTILIZABLES` para crear nuevas lecciones de forma consistente.

## Criterio de diseño

La formación no se apoya en explicaciones genéricas sobre IA. Cada bloque debe poder rastrearse a documentación, cursos oficiales o repositorios mantenidos por las organizaciones responsables.

## Principio pedagógico central

Cada concepto se enseña en cuatro profundidades:
...
Y cada práctica sigue este ciclo:

`CHECK -> DO -> BREAK -> FIX -> EXPLAIN`

## Carpetas principales

- [[../01_INVESTIGACION_OFICIAL/README|Research oficial]]
- [[../02_METODO_DE_ENSENANZA/README|Sistema pedagógico]]
- [[../03_RUTA_DEL_CURSO/README|Currículo]]
- [[../04_CLASES_POR_HERRAMIENTA/00_AI_Foundations/00_Resumen/README|Módulos]]
- [[../05_PRACTICAS_Y_EJERCICIOS/README|Laboratorios]]
- [[../06_PROYECTOS_PARA_PORTFOLIO/README|Proyectos]]
- [[../07_EXAMENES_RUBRICAS_DEFENSA/README|Evaluaciones]]
- [[../08_PLANTILLAS_REUTILIZABLES/README|Plantillas]]
- [[../09_DICCIONARIO_DE_IA/Glosario_base|Glosario]]
- [[../10_GUIAS_WINDOWS_MAC_LINUX/README|Sistemas operativos]]
- [[../11_MANUAL_PARA_CREAR_PROYECTOS/Como_llevar_a_cabo_cualquier_proyecto|Manual de proyectos]]
- [[../12_FASES_DEL_APRENDIZAJE/README|Fases de la formación]]
- [[../13_PROYECTOS_REALES_Y_SKILLS/README|Proyectos reales y skills oficiales]]
- [[../14_ESTANDAR_AAAA_PLUS/README|Estandar AAAA+]]
...
- [[../21_TROUBLESHOOTING_Y_ERRORES_REALES/README|Troubleshooting real]]
...
Para Inicio, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para Inicio es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa ultra-premium AAAA+ - Inicio
...
Usar **Inicio** para producir el entregable definido en la metadata: **mapa de navegacion**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Inicio**.
