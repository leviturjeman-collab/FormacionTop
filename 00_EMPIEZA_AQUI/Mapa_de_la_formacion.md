...
Formar a una persona para pasar de usuario de IA a operador profesional capaz de diseñar workflows, agentes, automatizaciones, skills, herramientas, integraciones y sistemas desplegables con evaluación, seguridad y control de costes.

## Secuencia recomendada

La secuencia principal ahora se organiza por fases:

1. [[../12_FASES_DEL_APRENDIZAJE/Fase_00_Orientacion_y_diagnostico|Fase 00 - Orientación y diagnóstico]]
2. [[../12_FASES_DEL_APRENDIZAJE/Fase_01_Aprendizaje|Fase 01 - Aprendizaje]]
3. [[../12_FASES_DEL_APRENDIZAJE/Fase_02_Aplicacion_a_trabajo_e_ideas|Fase 02 - Aplicación a trabajo e ideas]]
4. [[../12_FASES_DEL_APRENDIZAJE/Fase_03_Construccion_de_proyectos|Fase 03 - Construcción de proyectos]]
5. [[../12_FASES_DEL_APRENDIZAJE/Fase_04_Automatizacion_agentes_y_sistemas|Fase 04 - Automatización, agentes y sistemas]]
6. [[../12_FASES_DEL_APRENDIZAJE/Fase_05_Produccion_portfolio_y_escala|Fase 05 - Producción, portfolio y escala]]

La capa de proyectos reales debe consultarse en paralelo:

- [[../13_PROYECTOS_REALES_Y_SKILLS/README|Proyectos reales y skills oficiales]]
- [[../13_PROYECTOS_REALES_Y_SKILLS/04_Matrices/Matriz_de_proyectos_por_fase|Matriz de proyectos por fase]]
- [[../13_PROYECTOS_REALES_Y_SKILLS/04_Matrices/Catalogo_de_skills_eficientes|Catálogo de skills eficientes]]
- [[../15_HERRAMIENTAS_OFICIALES_AVANZADAS/README|Herramientas oficiales avanzadas]]
- [[../15_HERRAMIENTAS_OFICIALES_AVANZADAS/Mapa_Comparativo_Que_Usar_Y_Cuando|Qué usar y cuándo]]
- [[../16_CASOS_POR_PROFESION/README|Casos por profesion]]
- [[../17_ROADMAPS_30_60_90_DIAS/README|Roadmaps 30/60/90 dias]]
- [[../18_PROMPTS_PROFESIONALES/README|Prompts profesionales]]
- [[../19_PRODUCTIZACION_Y_NEGOCIO/README|Productizacion y negocio]]
- [[../20_CAPSTONE_FINAL/README|Capstone final]]
- [[../21_TROUBLESHOOTING_Y_ERRORES_REALES/README|Troubleshooting y errores reales]]
- [[../22_BIBLIOTECA_DE_ENTREGABLES/README|Biblioteca de entregables]]
- [[../23_AUDITORIA_PROFESIONAL/Informe_de_lo_que_falta_por_archivo|Auditoria profesional]]
- [[../24_CERTIFICACION_Y_ACREDITACION/README|Certificacion y acreditacion]]
- [[../25_ACTUALIZACIONES_Y_VERSIONADO/README|Actualizaciones y versionado]]
- [[../26_LECCIONES_LISTAS_PARA_IMPARTIR/README|Lecciones listas para impartir]]
- [[../27_ASSETS_EJECUTABLES_Y_DEMOS/README|Assets ejecutables y demos]]
- [[../28_LEGAL_PRIVACIDAD_Y_ETICA/README|Legal, privacidad y etica]]
- [[../29_PRESENTACIONES_Y_GUIONES/README|Presentaciones y guiones]]
- [[../30_ONBOARDING_DEL_ALUMNO/README|Onboarding del alumno]]

Los módulos siguen existiendo como biblioteca temática:

- [[../04_CLASES_POR_HERRAMIENTA/00_AI_Foundations/00_Resumen/README|AI Foundations]]
- [[../04_CLASES_POR_HERRAMIENTA/01_ChatGPT_Workflows/00_Resumen/README|ChatGPT y workflows]]
- [[../04_CLASES_POR_HERRAMIENTA/02_Codex/00_Resumen/README|Codex]]
- [[../04_CLASES_POR_HERRAMIENTA/03_Claude_Claude_Code/00_Resumen/README|Claude y Claude Code]]
- [[../04_CLASES_POR_HERRAMIENTA/04_Gemini/00_Resumen/README|Gemini]]
- [[../04_CLASES_POR_HERRAMIENTA/05_GitHub_Skills_Copilot/00_Resumen/README|GitHub Skills y Copilot agents]]
- [[../04_CLASES_POR_HERRAMIENTA/06_n8n_Automation_AI/00_Resumen/README|n8n, automatización e IA]]
- [[../04_CLASES_POR_HERRAMIENTA/07_Agentes_MCP_Skills/00_Resumen/README|Agentes, MCP y skills]]
- [[../04_CLASES_POR_HERRAMIENTA/08_Produccion_Seguridad_Evals/00_Resumen/README|Producción, seguridad y evals]]

## Modelo mental transversal
...
DETERMINISTIC           LLM
         ...
         TOOL          SKILL           MCP
          |              |              |
        APIs        PROCEDURE       EXTERNAL SYSTEM
          |
       DATABASE
          |
    PERMISSIONS
...
Para Mapa de la formacion, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para Mapa de la formacion es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa AAAA+ - Mapa De La Formacion

## Proposito profesional de esta nota

Esta nota queda elevada al estandar AAAA+. Su funcion dentro de la boveda es servir como pieza profesional de navegacion estrategica de la boveda, orientacion del alumno y toma de decisiones sobre ruta de aprendizaje. No debe leerse como una nota aislada ni como un resumen rapido. Debe poder ayudar a un alumno a entender el tema, aplicarlo a su trabajo, convertirlo en proyecto, evaluarlo y defenderlo con criterio.
...
Para trabajar esta nota, utiliza: Obsidian, enlaces internos, plantillas, checklists, fuentes y estructura de navegacion.
...
# Masterclass AAAA+ - Mapa De La Formacion
...
# Capa ultra-premium AAAA+ - Mapa De La Formacion
...
Usar **Mapa de la formacion** para producir el entregable definido en la metadata: **mapa de navegacion**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Mapa de la formacion**.
