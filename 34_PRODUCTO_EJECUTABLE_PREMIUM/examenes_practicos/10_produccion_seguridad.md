# Examen practico - Produccion Seguridad

## Basico

Explica el concepto central del modulo, define entrada y salida, y crea una ficha de una pagina.
...
Construye una demo pequena usando una herramienta adecuada. Debe incluir caso feliz y caso ambiguo.
...
Rompe la demo de forma controlada y reparala con evidencia.
...
| Criterio | 1 | 2 | 3 | 4 |
|---|---|---|---|---|
| Claridad | confuso | comprensible | claro | ensenable |
| Evidencia | no hay | parcial | suficiente | reproducible |
| Seguridad | ignora riesgos | menciona | mitiga | documenta rollback |
| Defensa | memoriza | explica | justifica | transfiere a caso real |

<!-- DESARROLLO_EXTENSO_PREMIUM_2026_08_18 -->

# Desarrollo extenso premium - 10 Produccion Seguridad
