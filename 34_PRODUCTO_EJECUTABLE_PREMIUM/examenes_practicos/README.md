# Examenes practicos por modulo

| Modulo | Basico | Intermedio | Avanzado | Solucionario |
|---|---|---|---|---|
| AI Foundations | ficha | demo | ruptura y reparacion | [[../solucionarios/01_ai_foundations_solucionario]] |
| ChatGPT Workflows | ficha | demo | ruptura y reparacion | [[../solucionarios/02_chatgpt_workflows_solucionario]] |
| Codex | ficha | demo | ruptura y reparacion | [[../solucionarios/03_codex_solucionario]] |
| Claude Code | ficha | demo | ruptura y reparacion | [[../solucionarios/04_claude_code_solucionario]] |
| Gemini | ficha | demo | ruptura y reparacion | [[../solucionarios/05_gemini_solucionario]] |
| GitHub Skills | ficha | demo | ruptura y reparacion | [[../solucionarios/06_github_skills_solucionario]] |
| n8n Base | ficha | demo | ruptura y reparacion | [[../solucionarios/07_n8n_base_solucionario]] |
| n8n AI | ficha | demo | ruptura y reparacion | [[../solucionarios/08_n8n_ai_solucionario]] |
| Agentes MCP Skills | ficha | demo | ruptura y reparacion | [[../solucionarios/09_agentes_mcp_skills_solucionario]] |
| Produccion Seguridad | ficha | demo | ruptura y reparacion | [[../solucionarios/10_produccion_seguridad_solucionario]] |
...
Este archivo debe tratarse como una pieza de **examen practico** dentro de la formacion. Su funcion no es rellenar la boveda con contenido, sino ayudar a una persona real a producir un resultado verificable. En esta academia, una nota esta terminada cuando el alumno puede abrirla, entender el objetivo, preparar los materiales, ejecutar una practica, provocar un fallo, repararlo, guardar evidencia y defender lo aprendido con sus palabras.

El proposito concreto de esta pieza es **medir competencia observable con evidencia, no memoria teorica**. Eso significa que el profesor no debe usarla como lectura pasiva. Debe convertirla en actividad, demostracion, evaluacion o entregable. Si el alumno solo lee y asiente, todavia no hay aprendizaje profesional. Si el alumno produce una evidencia, detecta un limite y explica una decision, entonces la pieza empieza a cumplir su funcion.
