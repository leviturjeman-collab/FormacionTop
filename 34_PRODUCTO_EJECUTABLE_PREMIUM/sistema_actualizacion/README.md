# Sistema de actualizacion mensual

## Objetivo

Revisar cada mes repos, docs oficiales, modelos, precios, herramientas obsoletas y cambios de comandos.

## Checklist mensual

- Revisar estrellas GitHub de repos top.
- Revisar docs oficiales: OpenAI, Anthropic, Gemini, n8n, Docker, Supabase, Vercel, GitHub Actions.
- Revisar modelos nuevos y deprecados.
- Revisar comandos de instalacion.
- Probar 3 workflows n8n al azar.
- Probar 2 mini repos.
- Actualizar changelog.

## Entregable

Informe mensual con cambios, riesgos, acciones y archivos tocados.
