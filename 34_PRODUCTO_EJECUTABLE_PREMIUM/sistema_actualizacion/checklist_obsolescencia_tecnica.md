# Checklist obsolescencia tecnica

| Area | Pregunta | Accion |
|---|---|---|
| Modelos | cambio nombre/precio? | actualizar guias |
| CLIs | cambio comando install? | actualizar setup |
| Repos | bajaron mantenimiento? | marcar riesgo |
| n8n | cambio nodos/exports? | probar workflows |
| Deploy | cambio env/logs? | actualizar guia |

<!-- DESARROLLO_EXTENSO_PREMIUM_2026_08_18 -->

# Desarrollo extenso premium - Checklist Obsolescencia Tecnica
