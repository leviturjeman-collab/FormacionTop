# Caso de estudio - negocio_local

## Problema

Restaurante quiere automatizar reservas y leads.

## Solucion propuesta

Workflow o agente con entradas claras, datos ficticios, aprobacion humana y logs.

## Arquitectura

Usuario -> Formulario/Webhook -> Validacion -> LLM/Reglas -> Tool -> Revision humana -> Entrega.

## Coste y riesgos

- Coste por ejecucion estimado.
- Riesgo de datos sensibles.
- Riesgo de output no verificable.
- Riesgo de permisos excesivos.

## Entregables

- Workflow o repo base.
- Dataset ficticio.
- Caso feliz.
- Caso roto.
- Solucionario.
...
Medir uso real, anadir evals y preparar version portfolio.

<!-- DESARROLLO_EXTENSO_PREMIUM_2026_08_18 -->

# Desarrollo extenso premium - Negocio Local
