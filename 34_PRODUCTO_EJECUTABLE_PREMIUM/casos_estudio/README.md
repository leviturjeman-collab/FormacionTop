...
|---|---|---|
| negocio_local | Restaurante quiere automatizar reservas y leads | [[negocio_local]] |
| agencia | Agencia quiere crear reportes y propuestas mas rapido | [[agencia]] |
| ecommerce | Tienda online quiere enriquecer productos y soporte | [[ecommerce]] |
| formador | Formador quiere convertir contenido en clases | [[formador]] |
| programador | Programador quiere agente de mantenimiento | [[programador]] |
| consultor | Consultor quiere auditorias IA repetibles | [[consultor]] |
| clinica | Clinica necesita FAQ sin datos sensibles | [[clinica]] |
| inmobiliaria | Inmobiliaria quiere clasificar contactos | [[inmobiliaria]] |
| backoffice | Equipo operaciones quiere automatizar tickets | [[backoffice]] |
| creador_video | Creador quiere pipeline de video IA | [[creador_video]] |
...
Este archivo debe tratarse como una pieza de **caso de estudio** dentro de la formacion. Su funcion no es rellenar la boveda con contenido, sino ayudar a una persona real a producir un resultado verificable. En esta academia, una nota esta terminada cuando el alumno puede abrirla, entender el objetivo, preparar los materiales, ejecutar una practica, provocar un fallo, repararlo, guardar evidencia y defender lo aprendido con sus palabras.

El proposito concreto de esta pieza es **demostrar valor real con problema, solucion, costes, riesgos y defensa**. Eso significa que el profesor no debe usarla como lectura pasiva. Debe convertirla en actividad, demostracion, evaluacion o entregable. Si el alumno solo lee y asiente, todavia no hay aprendizaje profesional. Si el alumno produce una evidencia, detecta un limite y explica una decision, entonces la pieza empieza a cumplir su funcion.
