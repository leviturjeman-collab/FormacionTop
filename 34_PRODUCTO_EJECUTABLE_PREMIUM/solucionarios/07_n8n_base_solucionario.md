# Solucionario - n8n Base

## Respuesta basica esperada

El alumno separa problema, entrada, proceso, salida y limite. No promete capacidades no probadas.

## Respuesta intermedia esperada

La demo funciona con datos ficticios, guarda evidencia y explica por que la herramienta elegida es suficiente.

## Respuesta avanzada esperada

El fallo se diagnostica con evidencia: logs, status code, diff, output, schema o checklist. La reparacion reduce repeticion del error.

## Errores comunes

- Saltar a herramienta avanzada sin criterio.
- No definir salida verificable.
- No probar caso roto.
- Usar secretos reales.
- No explicar rollback.

<!-- DESARROLLO_EXTENSO_PREMIUM_2026_08_18 -->

# Desarrollo extenso premium - 07 N8N Base Solucionario
