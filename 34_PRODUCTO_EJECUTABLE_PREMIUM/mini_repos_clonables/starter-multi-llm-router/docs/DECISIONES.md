...
- Stack elegido: starter-multi-llm-router
- Riesgo principal: variables, permisos o deploy.
- Criterio de terminado: demo reproducible + caso roto reparado.

<!-- DESARROLLO_EXTENSO_PREMIUM_2026_08_18 -->

# Desarrollo extenso premium - Decisiones
