# starter-multi-llm-router

Router multi-LLM con fallback. Objetivo: comparar respuestas y registrar fallos sin casarse con un proveedor.

## Caso feliz

Ejecutar la demo con variables ficticias y guardar evidencia.

## Caso roto

Quitar una variable, romper un payload o ejecutar sin dependencia. Documentar sintoma, causa y reparacion.

## Defensa

Explicar entrada, proceso, salida, riesgos y siguiente mejora.
