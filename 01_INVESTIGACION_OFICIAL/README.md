...
Esta carpeta recoge la investigación base. La regla es simple: cada lección importante debe poder apuntar a una fuente oficial o a un repositorio mantenido por la organización responsable.

## Fuentes principales

- [[OpenAI_Academy_ChatGPT_Codex]]
- [[Anthropic_Claude_Claude_Code]]
- [[Gemini]]
- [[GitHub_Skills_Copilot_Agents]]
- [[n8n]]
- [[Sintesis_de_research]]

## Criterios de selección

- Priorizar documentación oficial.
- Priorizar cursos oficiales cuando existan.
- Usar repositorios oficiales solo cuando aporten ejercicios, ejemplos o estructura.
- Evitar contenido genérico si no añade práctica.
- Revisar fechas y notas de producto antes de producir material final.
---

# Desarrollo completo - 01 Research Oficial

## Funcion dentro de la academia

Esta nota forma parte de la boveda de Obsidian de AI Professional Academy y debe leerse como material de estudio, no como un simple indice. Su funcion es desarrollar el tema INVESTIGACION OFICIAL dentro del contexto de research oficial, documentacion primaria, sintesis pedagogica y actualizacion de fuentes. El objetivo es que el alumno pueda abrir este archivo, entender que papel ocupa en la formacion, estudiar el concepto con calma, practicarlo y despues convertirlo en una idea propia, un documento, una presentacion, un laboratorio o una pieza de un proyecto final.
...
Para INVESTIGACION OFICIAL, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para INVESTIGACION OFICIAL es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Masterclass AAAA+ - 01 Research Oficial
...
# Capa ultra-premium AAAA+ - 01 Research Oficial
...
Usar **INVESTIGACION OFICIAL** para producir el entregable definido en la metadata: **manual con fuentes y practica**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **INVESTIGACION OFICIAL**.
