...
## Tesis de la formación

La academia debe formar criterio operativo, no solo conocimiento declarativo. El alumno debe aprender a decidir cuándo una tarea necesita prompt, workflow, skill, tool, agente, MCP, base de datos, aprobación humana, evaluación o despliegue.

## Pilares

- Documentación oficial como fuente.
- Práctica desde el principio.
- Errores provocados como método.
- Evaluación por explicación, no por memoria.
- Seguridad, permisos y coste como parte del diseño.
- Obsidian como sistema de producción de materiales.

## Decisiones tomadas

- OpenAI estructura la progresión general.
- Codex enseña trabajo técnico asistido por agentes.
- Claude enseña prompting profundo y extensibilidad de agentes.
- Gemini enseña API moderna, tokens, grounding y agentes administrados.
- GitHub enseña skills, custom agents y cursos accionables.
- n8n enseña automatización real y agentes conectados a herramientas.
---

# Desarrollo completo - Sintesis De Research

## Funcion dentro de la academia

Esta nota forma parte de la boveda de Obsidian de AI Professional Academy y debe leerse como material de estudio, no como un simple indice. Su funcion es desarrollar el tema Sintesis de research dentro del contexto de research oficial, documentacion primaria, sintesis pedagogica y actualizacion de fuentes. El objetivo es que el alumno pueda abrir este archivo, entender que papel ocupa en la formacion, estudiar el concepto con calma, practicarlo y despues convertirlo en una idea propia, un documento, una presentacion, un laboratorio o una pieza de un proyecto final.
...
Para Sintesis de research, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para Sintesis de research es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa AAAA+ - Sintesis De Research
...
# Masterclass AAAA+ - Sintesis De Research
...
# Capa ultra-premium AAAA+ - Sintesis De Research
...
Usar **Sintesis de research** para producir el entregable definido en la metadata: **manual con fuentes y practica**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Sintesis de research**.
