...
---
# Laboratorio - Skill PR reviewer

## Objetivo

Crear una skill para revisar cambios de código priorizando bugs, riesgos y tests.

## Resultado

Una review con findings ordenados por severidad, referencias concretas y preguntas abiertas.

## BREAK

Incluir un cambio que parece correcto pero rompe un caso límite.

## FIX

La skill debe exigir evidencia, prueba o razonamiento reproducible.
---

# Desarrollo completo - Lab Pr Reviewer

## Funcion dentro de la academia

Esta nota forma parte de la boveda de Obsidian de AI Professional Academy y debe leerse como material de estudio, no como un simple indice. Su funcion es desarrollar el tema Lab pr reviewer dentro del contexto de laboratorios practicos, diagnostico, construccion, rotura controlada, reparacion y explicacion. El objetivo es que el alumno pueda abrir este archivo, entender que papel ocupa en la formacion, estudiar el concepto con calma, practicarlo y despues convertirlo en una idea propia, un documento, una presentacion, un laboratorio o una pieza de un proyecto final.
...
Para Lab pr reviewer, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para Lab pr reviewer es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Masterclass AAAA+ - Lab Pr Reviewer
...
# Capa ultra-premium AAAA+ - Lab Pr Reviewer
...
Usar **Lab pr reviewer** para producir el entregable definido en la metadata: **laboratorio reproducible con error y reparacion**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Lab pr reviewer**.
