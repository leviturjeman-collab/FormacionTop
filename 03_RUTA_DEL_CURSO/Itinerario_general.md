...
AI Foundations, ChatGPT y workflows. El alumno aprende a pensar en tareas, contexto, límites y revisión.

## Fase 2 - Herramientas profesionales

Codex, Claude Code, Gemini y GitHub Copilot. El alumno aprende a trabajar con agentes técnicos, APIs, skills y herramientas.

## Fase 3 - Automatización

n8n base y n8n con IA. El alumno aprende cómo viajan los datos y cómo conectar herramientas reales.

## Fase 4 - Arquitectura agentica

Agentes, MCP, tools, skills, permisos, human approval y auditoría.

## Fase 5 - Producción

Evals, seguridad, costes, observabilidad, despliegue y mantenimiento.
---

# Desarrollo completo - Itinerario General

## Funcion dentro de la academia

Esta nota forma parte de la boveda de Obsidian de AI Professional Academy y debe leerse como material de estudio, no como un simple indice. Su funcion es desarrollar el tema Itinerario general dentro del contexto de curriculo, progresion, prerequisitos, competencias y resultados de aprendizaje. El objetivo es que el alumno pueda abrir este archivo, entender que papel ocupa en la formacion, estudiar el concepto con calma, practicarlo y despues convertirlo en una idea propia, un documento, una presentacion, un laboratorio o una pieza de un proyecto final.
...
Para Itinerario general, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para Itinerario general es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa AAAA+ - Itinerario General

## Proposito profesional de esta nota

Esta nota queda elevada al estandar AAAA+. Su funcion dentro de la boveda es servir como pieza profesional de curriculo, progresion, prerequisitos, competencias y resultados por nivel. No debe leerse como una nota aislada ni como un resumen rapido. Debe poder ayudar a un alumno a entender el tema, aplicarlo a su trabajo, convertirlo en proyecto, evaluarlo y defenderlo con criterio.
...
# Masterclass AAAA+ - Itinerario General
...
# Capa ultra-premium AAAA+ - Itinerario General
...
Usar **Itinerario general** para producir el entregable definido en la metadata: **guia de clase o ruta de aprendizaje**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Itinerario general**.
