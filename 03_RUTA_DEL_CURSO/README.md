...
Una persona que termina esta formación debe poder:

- Diseñar workflows asistidos por IA.
- Trabajar con Codex y Claude Code de forma profesional.
- Crear skills y agentes especializados.
- Construir automatizaciones n8n con IA.
- Usar APIs de modelos con outputs estructurados.
- Medir tokens, costes y usage.
- Aplicar permisos mínimos, revisión humana y evals.
- Documentar y presentar sistemas de IA.
---

# Desarrollo completo - 03 Curriculo

## Funcion dentro de la academia

Esta nota forma parte de la boveda de Obsidian de AI Professional Academy y debe leerse como material de estudio, no como un simple indice. Su funcion es desarrollar el tema RUTA DEL CURSO dentro del contexto de curriculo, progresion, prerequisitos, competencias y resultados de aprendizaje. El objetivo es que el alumno pueda abrir este archivo, entender que papel ocupa en la formacion, estudiar el concepto con calma, practicarlo y despues convertirlo en una idea propia, un documento, una presentacion, un laboratorio o una pieza de un proyecto final.
...
Para RUTA DEL CURSO, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para RUTA DEL CURSO es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa ultra-premium AAAA+ - 03 Curriculo
...
Usar **RUTA DEL CURSO** para producir el entregable definido en la metadata: **guia de clase o ruta de aprendizaje**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **RUTA DEL CURSO**.
