---
titulo: "Diseño de clases y duracion"
...
---
# Diseño de clases y duración

## Regla de duración

Las unidades deben poder consumirse en bloques de 30 a 45 minutos cuando sean prácticas. Si un tema necesita más tiempo, se divide.

## Formato recomendado

- 5 minutos: contexto y objetivo.
- 5 minutos: modelo mental.
- 15 minutos: práctica.
- 10 minutos: error provocado y reparación.
- 5 minutos: explicación final.

## Materiales por clase

- Documento MD.
- Diagrama o modelo mental.
- Ejercicio.
- Error provocado.
...
Para Diseño de clases y duracion, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para Diseño de clases y duracion es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa AAAA+ - Diseño De Clases Y Duracion
...
# Masterclass AAAA+ - Diseño De Clases Y Duracion
...
# Capa ultra-premium AAAA+ - Diseño De Clases Y Duracion
...
Usar **Diseño de clases y duracion** para producir el entregable definido en la metadata: **guia de clase o ruta de aprendizaje**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Diseño de clases y duracion**.
