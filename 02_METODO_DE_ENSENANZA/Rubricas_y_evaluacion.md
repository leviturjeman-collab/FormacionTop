...
| Nivel | Descripción |
|---|---|
| 1 | Repite instrucciones pero no entiende el sistema. |
| 2 | Completa la práctica con ayuda. |
| 3 | Completa, verifica y explica el resultado. |
| 4 | Diagnostica errores y justifica decisiones. |
| 5 | Diseña mejoras, controla riesgos y documenta tradeoffs. |
...
- Tools necesarias y suficientes.
- Permisos mínimos.
- Aprobación humana cuando hay impacto.
- Auditoría.
- Evals.
- Control de tokens.
- Fallback seguro.
...
Para Rubricas y evaluacion, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para Rubricas y evaluacion es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa AAAA+ - Rubricas Y Evaluacion
...
Para trabajar esta nota, utiliza: rubricas, evidencias, defensa oral, casos felices, ambiguos y rotos.
...
# Masterclass AAAA+ - Rubricas Y Evaluacion
...
# Capa ultra-premium AAAA+ - Rubricas Y Evaluacion
...
Usar **Rubricas y evaluacion** para producir el entregable definido en la metadata: **guia de clase o ruta de aprendizaje**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Rubricas y evaluacion**.
