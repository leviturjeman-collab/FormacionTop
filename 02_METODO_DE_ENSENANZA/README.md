...
Crear una formación que produzca competencia real. El alumno no solo debe repetir conceptos: debe construir, romper, depurar, explicar y documentar.

## Archivos

- [[CHECK_DO_BREAK_FIX_EXPLAIN]]
- [[Plantilla_de_leccion]]
- [[Rubricas_y_evaluacion]]
- [[Diseño_de_clases_y_duracion]]
---

# Desarrollo completo - 02 Sistema Pedagogico

## Funcion dentro de la academia

Esta nota forma parte de la boveda de Obsidian de AI Professional Academy y debe leerse como material de estudio, no como un simple indice. Su funcion es desarrollar el tema METODO DE ENSENANZA dentro del contexto de metodo pedagogico, practica guiada, errores provocados, evaluacion y transferencia a proyectos reales. El objetivo es que el alumno pueda abrir este archivo, entender que papel ocupa en la formacion, estudiar el concepto con calma, practicarlo y despues convertirlo en una idea propia, un documento, una presentacion, un laboratorio o una pieza de un proyecto final.
...
Para METODO DE ENSENANZA, la pregunta central es: que cambia en el trabajo del alumno cuando domina este tema. Si el tema es una fuente, debe aprender a usarla para no depender de opiniones genericas. Si es una leccion, debe aprender a explicar y aplicar el concepto. Si es un laboratorio, debe construir algo, romperlo y repararlo. Si es una evaluacion, debe demostrar competencia observable. Si es una plantilla, debe producir materiales consistentes. Si es un modulo, debe conectar varias lecciones en una progresion clara.
...
Un buen check para METODO DE ENSENANZA es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa AAAA+ - 02 Sistema Pedagogico
...
# Masterclass AAAA+ - 02 Sistema Pedagogico
...
# Capa ultra-premium AAAA+ - 02 Sistema Pedagogico
...
Usar **METODO DE ENSENANZA** para producir el entregable definido en la metadata: **guia de clase o ruta de aprendizaje**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **METODO DE ENSENANZA**.
