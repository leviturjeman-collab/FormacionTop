---
titulo: "Assets de infraestructura profesional"
tipo: "assets_codigo"
...
tags: ["ai-academy", "infraestructura", "codigo", "assets"]
entregable: "codigo de infraestructura"
---
# Assets de infraestructura profesional

| Archivo | Uso |
|---|---|
| `docker-compose.postgres.yml` | Postgres local |
| `docker-compose.qdrant.yml` | Qdrant local |
| `github-actions-ci.yml` | CI base Node |
| `playwright-home.spec.ts` | Test E2E minimo |
| `env.full.example` | Variables por stack |

Estos assets acompanan [[../../33_INFRAESTRUCTURA_PROFESIONAL/README]].
