---
titulo: "Automatizaciones con codigo reutilizable"
tipo: "codigo_automatizacion"
nivel: "intermedio_avanzado"
fase: "construccion_portfolio"
estado: "borrador_accionable"
...
entregable: "26 automatizaciones con codigo"
---
# Automatizaciones con codigo reutilizable

Estos 26 assets son esqueletos didacticos. No incluyen credenciales reales y deben probarse con datos ficticios antes de conectarse a sistemas de cliente.

| ID | Archivo | Uso | Caso roto recomendado |
|---|---|---|---|
| A01 | `A01_router_multi_llm_litellm.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A02 | `A02_n8n_lead_classifier.js` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A03 | `A03_whisper_ffmpeg_subtitles.md` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A04 | `A04_remotion_video.tsx` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A05 | `A05_jina_reader.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A06 | `A06_browser_use_agent.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A07 | `A07_json_schema_validation.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A08 | `A08_llamaindex_rag.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A09 | `A09_haystack_pipeline.md` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A10 | `A10_human_approval_workflow.json` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A11 | `A11_secret_scanner.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A12 | `A12_postmortem_429.md` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A13 | `A13_batch_cost_guard.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A14 | `A14_compare_models.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A15 | `A15_video_brief_generator.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A16 | `A16_publish_automation_checklist.md` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A17 | `A17_skill_review_n8n.md` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A18 | `A18_rag_eval_prompt.txt` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A19 | `A19_csv_lead_normalizer.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A20 | `A20_webhook_payloads.json` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A21 | `A21_min_permission_tool.json` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A22 | `A22_tool_selector.py` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A23 | `A23_agent_eval_case.json` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A24 | `A24_execution_log.json` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A25 | `A25_delivery_template.md` | Esqueleto reutilizable para practica y entrega | dato faltante, permiso excesivo o salida no verificable |
| A26 | `A26_setup_terminal_homebrew_vercel_github_env.md` | Setup de terminal, GitHub, Vercel y variables de entorno | PATH roto, login ausente o variable no definida |

## Uso seguro

Cada automatizacion debe tener caso feliz, caso roto, logs o evidencia, y rollback. Si toca datos reales, necesita consentimiento, minimizacion de datos y revision humana.
...
Este archivo debe tratarse como una pieza de **asset de automatizacion** dentro de la formacion. Su funcion no es rellenar la boveda con contenido, sino ayudar a una persona real a producir un resultado verificable. En esta academia, una nota esta terminada cuando el alumno puede abrirla, entender el objetivo, preparar los materiales, ejecutar una practica, provocar un fallo, repararlo, guardar evidencia y defender lo aprendido con sus palabras.

El proposito concreto de esta pieza es **dar al alumno una pieza reutilizable con caso feliz y roto**. Eso significa que el profesor no debe usarla como lectura pasiva. Debe convertirla en actividad, demostracion, evaluacion o entregable. Si el alumno solo lee y asiente, todavia no hay aprendizaje profesional. Si el alumno produce una evidencia, detecta un limite y explica una decision, entonces la pieza empieza a cumplir su funcion.
