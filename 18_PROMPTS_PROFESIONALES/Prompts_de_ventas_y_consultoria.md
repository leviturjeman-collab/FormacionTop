---
titulo: "Prompts de ventas y consultoria"
...
---
# Prompts de ventas y consultoria

Estos prompts ayudan a convertir capacidades tecnicas en conversaciones comerciales responsables. No deben usarse para prometer resultados falsos, sino para aclarar problemas, alcance y valor.

## Discovery

```text
Actua como consultor de IA. Ayudame a preparar preguntas para descubrir oportunidades de automatizacion en [tipo de negocio]. Separa preguntas por: captacion, operaciones, soporte, contenido, reporting, ventas y riesgos. Incluye seÃ±ales de que NO conviene automatizar todavia.
```

## Propuesta

```text
Con esta informacion del cliente: [datos], crea una propuesta clara. Incluye problema, objetivo, alcance, fuera de alcance, fases, entregables, responsabilidades del cliente, riesgos, precio orientativo por rangos y siguiente paso. No prometas resultados no verificables.
```

## Caso de estudio

```text
Convierte este proyecto en caso de estudio. Estructura: contexto, problema, solucion, arquitectura, herramientas, antes/despues, resultados medibles, limites, aprendizajes y siguiente mejora.
```

## Practica

El alumno debe preparar una propuesta para un caso ficticio. BREAK: cliente pide automatizar un proceso que no entiende. FIX: vender primero auditoria o mapeo de proceso.


---

# Capa de desarrollo AAAA+ aplicada a Prompts de ventas y consultoria

## Para que sirve este archivo dentro de la formacion

Este archivo no debe leerse como una nota aislada. Su funcion dentro de la academia es convertir el tema Prompts de ventas y consultoria en una pieza util para aprender, aplicar, construir, documentar y defender trabajo real. La pregunta que debe guiar su uso es sencilla: que puede hacer el alumno despues de leerlo que antes no podia hacer con claridad. Si la respuesta no se puede convertir en una accion observable, una practica, una plantilla, una decision de herramientas o un entregable, el archivo debe ampliarse o conectarse con otro material de la boveda.
...
Una clase basada en Prompts de ventas y consultoria no deberia terminar con "lo hemos visto". Debe terminar con algo que el alumno pueda guardar en Obsidian: una checklist, una plantilla, un prompt, un workflow, un mini informe, una rubrica, un mapa de decision o una pieza de portfolio. Ese artefacto es la prueba de aprendizaje.

## Practica recomendada

La practica recomendada consiste en tomar un problema pequeÃƒÂ±o y usar Prompts de ventas y consultoria para resolverlo de forma limitada. Primero se define el objetivo. Despues se escribe el contexto. Luego se decide que herramienta o metodo se usara. A continuacion se construye una primera version. Despues se provoca un fallo. Finalmente se documenta la reparacion.
...
Para convertir Prompts de ventas y consultoria en entregable, aÃƒÂ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒÂ±ade alcance y mantenimiento. Si es para portfolio, aÃƒÂ±ade demo y caso de estudio. Si es para clase, aÃƒÂ±ade practica y rubrica. Si es para uso interno, aÃƒÂ±ade responsable y frecuencia de revision.
...
Usar **Prompts de ventas y consultoria** para producir el entregable definido en la metadata: **plantilla reutilizable**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Prompts de ventas y consultoria**.
