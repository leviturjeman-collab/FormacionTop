---
titulo: "Prompts de documentacion y cursos"
...
---
# Prompts de documentacion y cursos

Estos prompts ayudan a convertir conocimiento en material formativo. Deben respetar el metodo de la academia: explicar, practicar, romper, reparar y evaluar.

## Prompt de leccion AAAA+

```text
Convierte este tema en una leccion profesional para alumnos [nivel]. Incluye:
- objetivo,
- modelo mental,
...
- evaluacion,
- ideas de proyecto,
- fuentes que debo revisar.
Evita relleno y lenguaje de marketing.
```
...
```text
Crea una rubrica para evaluar [competencia]. Usa niveles: insuficiente, basico, intermedio, avanzado y AAAA+. Evalua claridad, ejecucion, diagnostico, seguridad, documentacion y defensa oral.
```

## Practica

El alumno toma cualquier archivo de la boveda y lo convierte en clase. BREAK: generar una clase sin ejercicios. FIX: anadir laboratorio con CHECK, DO, BREAK, FIX y EXPLAIN.


---

# Capa de desarrollo AAAA+ aplicada a Prompts de documentacion y cursos

## Para que sirve este archivo dentro de la formacion

Este archivo no debe leerse como una nota aislada. Su funcion dentro de la academia es convertir el tema Prompts de documentacion y cursos en una pieza util para aprender, aplicar, construir, documentar y defender trabajo real. La pregunta que debe guiar su uso es sencilla: que puede hacer el alumno despues de leerlo que antes no podia hacer con claridad. Si la respuesta no se puede convertir en una accion observable, una practica, una plantilla, una decision de herramientas o un entregable, el archivo debe ampliarse o conectarse con otro material de la boveda.
...
Usar **Prompts de documentacion y cursos** para producir el entregable definido en la metadata: **plantilla reutilizable**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Prompts de documentacion y cursos**.
