...
---
# Laboratorios - Claude y Claude Code

## Laboratorio 1 - Prompt robusto

Reescribir un prompt débil usando estructura, contexto, ejemplos y formato esperado.

## Laboratorio 2 - Hook determinista

Diseñar un hook que ejecute una validación antes de aceptar cambios.

## Laboratorio 3 - Subagent

Crear el perfil de un subagente especializado con permisos limitados.
---
