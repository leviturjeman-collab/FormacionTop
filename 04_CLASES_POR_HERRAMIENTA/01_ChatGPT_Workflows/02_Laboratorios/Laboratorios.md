...
---
# Laboratorios - ChatGPT y workflows

## Laboratorio 1 - De tarea a workflow

Elegir una tarea repetida del alumno y dividirla en entradas, pasos, decisiones, salida y verificación.

## Laboratorio 2 - Checklist de revisión

Crear una checklist para revisar documentos generados con IA.

## Laboratorio 3 - Plantilla reusable

Convertir un prompt útil en una plantilla con variables.
---
