...
fuentes: ["https://learn.chatgpt.com/", "https://developers.openai.com/", "https://docs.n8n.io/"]
tags: ["ai-academy", "modulo_clase", "transversal", "aprendizaje"]
entregable: "clase, practica y evaluacion"
---
# Lecciones - ChatGPT y workflows

1. ChatGPT como copiloto de trabajo.
2. Diferencia entre conversación y workflow.
3. Objetivo, contexto, límites y output.
4. Cómo pedir investigación.
5. Cómo pedir síntesis.
6. Cómo pedir documentos.
7. Cómo revisar resultados.
8. Cómo crear checklists.
9. Cómo convertir una tarea en plantilla.
10. Proyecto: workflow personal documentado.
---
