...
---
# Laboratorios - AI Foundations

## Laboratorio 1 - Prompt mÃ­nimo viable

El alumno transforma una peticiÃ³n ambigua en una instrucciÃ³n con objetivo, contexto, restricciones y salida esperada.

## Laboratorio 2 - VerificaciÃ³n

El alumno recibe una respuesta con errores mezclados con aciertos y debe separar afirmaciones verificables, supuestos y dudas.

## Laboratorio 3 - Tokens

El alumno compara una instrucciÃ³n corta, una instrucciÃ³n con contexto y una instrucciÃ³n con documentos para entender el coste del contexto.
---
...
Un buen check para Laboratorios es pedir al alumno que lo explique en tres niveles. En 60 segundos debe dar una version simple. En modelo mental debe dibujar o describir las piezas. En profundidad profesional debe mencionar limites, riesgos, verificaciones y fuentes. Si no puede hacer los tres niveles, la leccion necesita mas trabajo antes de pasar al laboratorio.
...
# Capa ultra-premium AAAA+ - Laboratorios
