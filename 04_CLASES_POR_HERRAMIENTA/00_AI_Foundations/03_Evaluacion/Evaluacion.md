...
tags: ["ai-academy", "modulo_clase", "basico", "aprendizaje"]
entregable: "clase, practica y evaluacion"
---
# Evaluación - AI Foundations

## Evidencia mínima

El alumno escribe una instrucción clara y explica cómo revisaría la respuesta.

## Errores comunes

- Pedir "hazlo mejor" sin criterio.
- No aportar contexto.
- No definir formato.
- Copiar la respuesta sin revisar.

## Criterio de excelencia

El alumno identifica límites, riesgos y verificaciones antes de usar el output.
---
...
Dominio: fundamentos de IA.

Este archivo trabaja principalmente sobre: modelo mental, tokens, contexto, verificacion y limites.

El resultado esperado no es solo conocimiento. El resultado esperado es: mapa conceptual, glosario aplicado y primer workflow responsable.
