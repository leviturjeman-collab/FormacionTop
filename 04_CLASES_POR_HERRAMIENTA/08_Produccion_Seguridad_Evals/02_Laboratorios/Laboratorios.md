...
---
# Laboratorios - Producción, seguridad y evals

## Laboratorio 1 - Checklist de producción

Crear una checklist para un agente que usa APIs externas.

## Laboratorio 2 - 429

Simular rate limit y diseñar retry, backoff y alerta.

## Laboratorio 3 - Eval set

Crear diez casos de prueba para detectar regresiones de comportamiento.
---
