...
El alumno explica input tokens, output tokens, thought tokens, cached tokens, tool-use tokens y total tokens.

## Criterio de excelencia

El alumno calcula coste estimado y propone límites de seguridad para un agente.
---
