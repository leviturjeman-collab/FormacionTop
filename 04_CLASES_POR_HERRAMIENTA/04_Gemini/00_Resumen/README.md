...
Usar Gemini para enseñar integración por API, structured outputs, function calling, grounding, tokens, usage y seguridad de agentes.
...
El alumno puede medir coste y uso, pedir salidas estructuradas y diseñar agentes con permisos controlados.
---
