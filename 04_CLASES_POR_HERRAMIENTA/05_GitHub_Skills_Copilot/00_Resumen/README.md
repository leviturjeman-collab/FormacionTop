...
---
# Módulo 05 - GitHub Skills y Copilot

## Manual base

Antes de desarrollar o impartir este módulo, leer [[../../../01_INVESTIGACION_OFICIAL/GitHub_Skills_Copilot_Agents|GitHub Skills, Copilot Agent Skills y custom agents]]. Ese archivo contiene el desarrollo largo con fuentes oficiales, estructura de cursos, `SKILL.md`, skills, custom agents, herramientas, scripts, MCP y seguridad.

## Objetivo

Enseñar la diferencia entre cursos GitHub Skills, agent skills, custom agents, instrucciones y MCP.
...
El alumno construye una skill real y entiende cómo empaquetar conocimiento operativo para agentes.

## Qué debe dominar el alumno

El alumno debe distinguir entre dos conceptos con nombres parecidos. GitHub Skills es una forma de crear cursos guiados en repositorios, normalmente con README, pasos, workflows de GitHub Actions y una experiencia de aprendizaje progresiva. Agent Skills para Copilot son carpetas con instrucciones, scripts y recursos que el agente puede cargar cuando una tarea lo requiere. Ambos sirven para empaquetar conocimiento, pero uno se orienta al alumno humano y el otro al agente.

En GitHub Skills, el alumno debe aprender a diseñar una experiencia práctica de 30 a 45 minutos, con objetivo claro, pasos pequeños, un resultado útil y ayudas si se queda bloqueado. En Agent Skills, debe aprender a crear un `SKILL.md` con frontmatter, descripción precisa, instrucciones, ejemplos, límites y, si procede, scripts. La descripción es crítica porque el agente puede decidir usar la skill por coincidencia semántica.

La diferencia entre custom instructions, skills y custom agents debe quedar cristalina. Las custom instructions son reglas generales del repositorio. Las skills son procedimientos especializados que se cargan solo cuando son relevantes. Los custom agents son perfiles de agente completos con comportamiento, herramientas y, opcionalmente, MCP servers. MCP conecta herramientas y datos externos, pero no sustituye la necesidad de permisos y revisión.

## Práctica principal

Cada alumno creará una skill. La recomendación inicial es elegir una de estas:
...
El error provocado será una skill demasiado amplia o con herramientas peligrosamente preaprobadas. El alumno tendrá que reducir el scope, mejorar la descripción, añadir límites y justificar por qué la skill debe existir.
---
...
- [Add Copilot agent skills](https://docs.github.com/en/copilot/how-tos/copilot-cli/customize-copilot/add-skills)
