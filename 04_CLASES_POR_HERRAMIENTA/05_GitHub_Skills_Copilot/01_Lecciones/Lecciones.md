...
---
# Lecciones - GitHub Skills y Copilot

1. GitHub Skills como plataforma educativa.
2. Diseño de cursos cortos.
3. README de curso.
4. GitHub Actions para aprendizaje.
5. Agent Skills.
6. Estructura de `SKILL.md`.
7. Skills versus instrucciones.
8. Custom agents.
9. Herramientas.
10. MCP.
11. Laboratorios de skills.
