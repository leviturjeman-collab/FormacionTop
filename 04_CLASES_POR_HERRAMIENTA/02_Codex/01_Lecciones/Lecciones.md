...
1. Qué es Codex.
2. Superficies de uso.
3. Preparar repositorio y contexto.
4. Cómo escribir una tarea.
5. Definición de terminado.
6. Planificación antes de editar.
7. Leer diffs.
8. Ejecutar pruebas.
9. Revisar PR.
10. Codex para mantenimiento.
11. Codex para modernización.
12. Crear skills para Codex.
---
