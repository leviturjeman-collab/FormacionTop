...
Una tarea de Codex con objetivo, contexto, límites, verificación y definición de terminado.

## Criterio de excelencia

El alumno detecta un cambio incorrecto en el diff y pide una corrección precisa.
---
