...
## Laboratorio 1 - Fix guiado

Codex corrige un bug pequeño. El alumno debe leer el diff y ejecutar pruebas.

## Laboratorio 2 - Review

Codex revisa un PR. El alumno clasifica hallazgos por severidad.

## Laboratorio 3 - Skill

Crear una skill mínima con descripción, instrucciones y criterio de uso.
---
