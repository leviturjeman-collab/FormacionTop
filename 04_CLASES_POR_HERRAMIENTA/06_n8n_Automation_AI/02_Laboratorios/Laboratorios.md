...
## Laboratorio 1 - Workflow sin IA

Crear un webhook, procesar JSON, llamar a una API y devolver una respuesta.

## Laboratorio 2 - Error handling

Romper una credencial, observar el error, arreglarlo y explicar el diagnóstico.

## Laboratorio 3 - AI Agent controlado

Crear un agente con una herramienta limitada y aprobación humana para acciones sensibles.
---
