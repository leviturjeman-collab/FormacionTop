...
Un workflow exportable con webhook, HTTP Request, manejo de error y documentación de entradas y salidas.

## Criterio de excelencia

El alumno explica cómo viajan los datos entre nodes y cómo limitaría permisos en producción.
---
