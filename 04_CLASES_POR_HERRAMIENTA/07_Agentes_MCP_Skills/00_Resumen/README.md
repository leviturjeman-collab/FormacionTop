...
---
# Módulo 07 - Agentes, MCP y skills

## Objetivo

Construir el modelo mental transversal que conecta producto, workflow, LLM, tools, skills, MCP, permisos, aprobación humana, logs, tokens, evals y producción.
...
El alumno puede diseñar una arquitectura agentica razonada y explicar por qué cada pieza existe.
---
