...
---
# Lecciones - Agentes, MCP y skills

1. Qué es un agente.
2. Qué no es un agente.
3. Prompt versus instruction.
4. Instruction versus skill.
5. Skill versus tool.
6. Tool versus MCP.
7. Custom agent.
