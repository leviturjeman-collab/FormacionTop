...
---
# Laboratorios - Agentes, MCP y skills

## Laboratorio 1 - Clasificador de arquitectura

El alumno recibe diez casos y decide si necesitan prompt, workflow, tool, skill, MCP o agente.

## Laboratorio 2 - Diseño con permisos

Diseñar un agente que pueda leer datos pero no modificarlos sin aprobación humana.

## Laboratorio 3 - Auditoría

Crear una tabla de logs mínimos para entender qué hizo el agente y cuánto costó.
---
