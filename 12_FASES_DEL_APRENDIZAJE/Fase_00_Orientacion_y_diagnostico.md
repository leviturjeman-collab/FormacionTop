...
El profesor pregunta: "si tuvieras que usar IA esta semana para mejorar algo real, que harias?". La respuesta revela si el alumno piensa en prompts sueltos, documentos, workflows, automatizaciones o proyectos.

## DO

El alumno completa su nota personal, abre [[../DOCUMENTO_MAESTRO]], revisa [[../10_GUIAS_WINDOWS_MAC_LINUX/README]] y hace [[../07_EXAMENES_RUBRICAS_DEFENSA/Evaluacion_diagnostica]].

## BREAK

El error provocado es elegir un proyecto demasiado avanzado. Por ejemplo, alguien sin terminal quiere construir un agente con Docker, MCP y base de datos. El profesor muestra por que esa decision aumenta friccion.

## FIX

El alumno reescala el proyecto: version minima en Obsidian o ChatGPT, despues workflow, despues automatizacion. Asi aprende a llevar ideas a cabo sin ahogarse en complejidad.

## EXPLAIN

El alumno explica su ruta: donde empieza, que quiere conseguir, que fase necesita primero y que proyecto minimo construira.
...
# Capa AAAA+ - Fase 00 Orientacion Y Diagnostico
...
# Masterclass AAAA+ - Fase 00 Orientacion Y Diagnostico
...
# Capa ultra-premium AAAA+ - Fase 00 Orientacion Y Diagnostico
