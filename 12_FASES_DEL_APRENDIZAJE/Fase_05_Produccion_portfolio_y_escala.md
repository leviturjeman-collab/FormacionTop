...
El profesor pregunta: "que pasaria si esto falla delante de un usuario real?". Si el alumno no puede responder, el proyecto no esta listo para produccion.

## DO

El alumno prepara su proyecto final:
...
- API key filtrada.
- Falta de logs.
- Eval que no detecta fallo.
- Coste sin limite.
- Permiso excesivo.
- Sin rollback.
- Proyecto que solo funciona en el ordenador del creador.

## FIX

El alumno corrige documentacion, permisos, secretos, evaluaciones, instalacion y verificacion. Tambien prepara una guia para que otra persona pueda ejecutar o entender el proyecto.

## EXPLAIN

La defensa final debe responder:

- Que problema resuelve.
- Como funciona.
- Que necesita para ejecutarse.
- Que sistema operativo se uso.
- Que riesgos tiene.
- Que controles tiene.
- Como se evalua.
- Como se mantiene.
...
# Capa AAAA+ - Fase 05 Produccion Portfolio Y Escala
...
# Masterclass AAAA+ - Fase 05 Produccion Portfolio Y Escala
...
# Capa ultra-premium AAAA+ - Fase 05 Produccion Portfolio Y Escala
