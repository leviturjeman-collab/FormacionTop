---
titulo: "TROUBLESHOOTING Y ERRORES REALES"
...
---
# Troubleshooting y errores reales

Esta carpeta entrena diagnostico. Una formacion profesional de IA no puede limitarse a ense̱ar caminos felices. Los proyectos reales fallan: claves API mal configuradas, permisos insuficientes, JSON roto, webhooks duplicados, modelos lentos, agentes que llaman tools incorrectas, workflows que reciben datos incompletos y codigo que rompe tests. El alumno debe aprender a mirar evidencia.

## Archivos

- [[Errores_API_keys_401_403_429]]
- [[JSON_outputs_estructurados_y_schemas]]
- [[Webhooks_n8n_y_ejecuciones_duplicadas]]
- [[Agentes_tools_MCP_y_permisos]]
- [[Codex_Cursor_ClaudeCode_y_diffs]]
- [[Ollama_modelos_locales_lentitud_y_memoria]]
...
3. Revisar salida.
4. Leer logs.
5. Comparar contra caso correcto.
6. Cambiar una cosa.
7. Verificar.
8. Documentar causa y prevencion.

La frase clave: no se adivina, se observa.
...
Usar **TROUBLESHOOTING Y ERRORES REALES** para producir el entregable definido en la metadata: **laboratorio reproducible con error y reparacion**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **TROUBLESHOOTING Y ERRORES REALES**.
...
|---|---|
| https://platform.openai.com/docs/guides/error-codes | Verificar comandos, permisos, errores o criterios tecnicos relacionados |
