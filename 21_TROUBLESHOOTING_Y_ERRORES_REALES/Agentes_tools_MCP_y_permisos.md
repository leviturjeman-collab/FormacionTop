...
Reducir herramientas, mejorar nombres, aÃ±adir ejemplos, exigir confirmacion humana, limitar permisos y separar lectura de escritura.
...
Para convertir Agentes tools MCP y permisos en entregable, aÃƒÂ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒÂ±ade alcance y mantenimiento. Si es para portfolio, aÃƒÂ±ade demo y caso de estudio. Si es para clase, aÃƒÂ±ade practica y rubrica. Si es para uso interno, aÃƒÂ±ade responsable y frecuencia de revision.
