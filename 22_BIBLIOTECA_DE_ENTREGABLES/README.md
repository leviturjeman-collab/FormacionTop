---
titulo: "BIBLIOTECA DE ENTREGABLES"
...
Esta carpeta contiene plantillas para que el alumno salga con piezas profesionales. Un entregable no es solo el resultado; es la forma en que otra persona entiende, usa y confia en el resultado.

## Archivos

- [[Plantilla_propuesta_cliente]]
- [[Plantilla_auditoria_IA]]
- [[Plantilla_workflow_n8n]]
- [[Plantilla_documentacion_tecnica]]
- [[Plantilla_presentacion]]
- [[Plantilla_caso_de_estudio]]
- [[Plantilla_portfolio]]

## Regla AAAA+

Cada entregable debe tener objetivo, contexto, contenido, criterios de calidad, version final y siguiente accion. Si el alumno no puede entregar algo sin estar presente para explicarlo, la documentacion esta incompleta.
...
Usar **BIBLIOTECA DE ENTREGABLES** para producir el entregable definido en la metadata: **plantilla reutilizable**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **BIBLIOTECA DE ENTREGABLES**.
