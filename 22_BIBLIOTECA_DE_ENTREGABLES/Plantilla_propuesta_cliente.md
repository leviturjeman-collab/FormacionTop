---
titulo: "Plantilla propuesta cliente"
...
tags: ["ai-academy", "plantilla_entregable", "transversal", "construccion_portfolio"]
entregable: "plantilla reutilizable"
---
# Plantilla de propuesta a cliente

## Contexto

Cliente, sector, situacion actual y motivo de la propuesta.

## Problema

Describe el dolor operativo o comercial. Evita lenguaje generico.

## Objetivo

Que resultado concreto se busca.

## Solucion propuesta

Explica sistema, herramientas, flujo y entregables.
...
Diagnostico, diseÃ±o, implementacion, pruebas, entrega y soporte.

## Precio

Precio fijo, por fases o mantenimiento.

## Riesgos

Datos, permisos, dependencias, adopcion y mantenimiento.

## Siguiente paso

Reunion, aprobacion, pago inicial o acceso a informacion.


---

# Capa de desarrollo AAAA+ aplicada a Plantilla propuesta cliente

## Para que sirve este archivo dentro de la formacion

Este archivo no debe leerse como una nota aislada. Su funcion dentro de la academia es convertir el tema Plantilla propuesta cliente en una pieza util para aprender, aplicar, construir, documentar y defender trabajo real. La pregunta que debe guiar su uso es sencilla: que puede hacer el alumno despues de leerlo que antes no podia hacer con claridad. Si la respuesta no se puede convertir en una accion observable, una practica, una plantilla, una decision de herramientas o un entregable, el archivo debe ampliarse o conectarse con otro material de la boveda.
...
Una clase basada en Plantilla propuesta cliente no deberia terminar con "lo hemos visto". Debe terminar con algo que el alumno pueda guardar en Obsidian: una checklist, una plantilla, un prompt, un workflow, un mini informe, una rubrica, un mapa de decision o una pieza de portfolio. Ese artefacto es la prueba de aprendizaje.

## Practica recomendada

La practica recomendada consiste en tomar un problema pequeÃƒÂ±o y usar Plantilla propuesta cliente para resolverlo de forma limitada. Primero se define el objetivo. Despues se escribe el contexto. Luego se decide que herramienta o metodo se usara. A continuacion se construye una primera version. Despues se provoca un fallo. Finalmente se documenta la reparacion.
...
Para convertir Plantilla propuesta cliente en entregable, aÃƒÂ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒÂ±ade alcance y mantenimiento. Si es para portfolio, aÃƒÂ±ade demo y caso de estudio. Si es para clase, aÃƒÂ±ade practica y rubrica. Si es para uso interno, aÃƒÂ±ade responsable y frecuencia de revision.
...
Usar **Plantilla propuesta cliente** para producir el entregable definido en la metadata: **plantilla reutilizable**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Plantilla propuesta cliente**.
