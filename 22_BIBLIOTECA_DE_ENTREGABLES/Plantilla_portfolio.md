...
OpenAI, Claude, Gemini, n8n, Cursor, Codex, Ollama, Hermes u otras.

## Demo

Enlace, captura o descripcion.

## Documentacion

README, arquitectura, pruebas y troubleshooting.
...
Usar **Plantilla portfolio** para producir el entregable definido en la metadata: **plantilla reutilizable**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Plantilla portfolio**.
