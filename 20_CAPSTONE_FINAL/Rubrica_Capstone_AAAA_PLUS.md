---
titulo: "Rubrica Capstone AAAA PLUS"
tipo: "proyecto"
nivel: "avanzado"
...
---
# Rubrica Capstone AAAA+

## Insuficiente

El proyecto es una demo sin problema claro. No hay documentacion, no hay pruebas y el alumno no puede explicar decisiones.

## Basico

El proyecto funciona en camino feliz. Hay descripcion general y una practica. Falta profundidad en errores, seguridad o mantenimiento.

## Intermedio

El proyecto tiene problema claro, arquitectura, herramientas justificadas, pruebas y documentacion. Incluye algun error provocado y reparacion.

## Avanzado

El proyecto integra varias capas, controla permisos, documenta costes, incluye fallback, evalua calidad y tiene entrega profesional.

## AAAA+

El proyecto parece entregable real para cliente o portfolio. Tiene demo, README, arquitectura, pruebas, troubleshooting, defensa oral, caso de estudio, plan de mantenimiento, criterios de privacidad y decision clara de que herramientas usa y cuales evita.
...
Una clase basada en Rubrica Capstone AAAA PLUS no deberia terminar con "lo hemos visto". Debe terminar con algo que el alumno pueda guardar en Obsidian: una checklist, una plantilla, un prompt, un workflow, un mini informe, una rubrica, un mapa de decision o una pieza de portfolio. Ese artefacto es la prueba de aprendizaje.

## Practica recomendada

La practica recomendada consiste en tomar un problema pequeÃƒÂ±o y usar Rubrica Capstone AAAA PLUS para resolverlo de forma limitada. Primero se define el objetivo. Despues se escribe el contexto. Luego se decide que herramienta o metodo se usara. A continuacion se construye una primera version. Despues se provoca un fallo. Finalmente se documenta la reparacion.
...
Para convertir Rubrica Capstone AAAA PLUS en entregable, aÃƒÂ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒÂ±ade alcance y mantenimiento. Si es para portfolio, aÃƒÂ±ade demo y caso de estudio. Si es para clase, aÃƒÂ±ade practica y rubrica. Si es para uso interno, aÃƒÂ±ade responsable y frecuencia de revision.
...
Usar **Rubrica Capstone AAAA PLUS** para producir el entregable definido en la metadata: **proyecto documentado para portfolio**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Rubrica Capstone AAAA PLUS**.
