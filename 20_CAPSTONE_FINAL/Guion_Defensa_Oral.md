...
La defensa oral demuestra que el alumno no solo ha construido algo, sino que entiende lo que construyo.

## Estructura

1. Problema: que duele y a quien.
2. Objetivo: que mejora buscabas.
3. Arquitectura: que piezas usa el sistema.
4. Herramientas: por que elegiste cada una.
5. Flujo: que entra, que pasa, que sale.
6. IA: donde razona el modelo y donde no.
7. Seguridad: permisos, datos y limites.
8. Error: que rompiste.
9. Reparacion: como lo diagnosticaste.
10. Resultado: que entregas.
11. Siguiente mejora: que haria despues.

## Preguntas dificiles

- Que ocurre si la IA inventa?
- Que pasa si falla una API?
- Como controlas coste?
- Que datos sensibles procesa?
- Por que no usaste otra herramienta?
- Como lo mantendria otra persona?

## Cierre

La frase final debe ser concreta: "Este sistema resuelve [problema] reduciendo [dolor] mediante [flujo], con revision humana en [punto] y mantenimiento mediante [plan]".


---

# Capa de desarrollo AAAA+ aplicada a Guion Defensa Oral

## Para que sirve este archivo dentro de la formacion

Este archivo no debe leerse como una nota aislada. Su funcion dentro de la academia es convertir el tema Guion Defensa Oral en una pieza util para aprender, aplicar, construir, documentar y defender trabajo real. La pregunta que debe guiar su uso es sencilla: que puede hacer el alumno despues de leerlo que antes no podia hacer con claridad. Si la respuesta no se puede convertir en una accion observable, una practica, una plantilla, una decision de herramientas o un entregable, el archivo debe ampliarse o conectarse con otro material de la boveda.
...
Una clase basada en Guion Defensa Oral no deberia terminar con "lo hemos visto". Debe terminar con algo que el alumno pueda guardar en Obsidian: una checklist, una plantilla, un prompt, un workflow, un mini informe, una rubrica, un mapa de decision o una pieza de portfolio. Ese artefacto es la prueba de aprendizaje.

## Practica recomendada

La practica recomendada consiste en tomar un problema pequeÃƒÂ±o y usar Guion Defensa Oral para resolverlo de forma limitada. Primero se define el objetivo. Despues se escribe el contexto. Luego se decide que herramienta o metodo se usara. A continuacion se construye una primera version. Despues se provoca un fallo. Finalmente se documenta la reparacion.
...
Para convertir Guion Defensa Oral en entregable, aÃƒÂ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒÂ±ade alcance y mantenimiento. Si es para portfolio, aÃƒÂ±ade demo y caso de estudio. Si es para clase, aÃƒÂ±ade practica y rubrica. Si es para uso interno, aÃƒÂ±ade responsable y frecuencia de revision.
...
Usar **Guion Defensa Oral** para producir el entregable definido en la metadata: **proyecto documentado para portfolio**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Guion Defensa Oral**.
