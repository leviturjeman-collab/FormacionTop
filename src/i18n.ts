...
const DICT = {
  es: {
    ...
    'admin.titulo': 'Profesor y superadmin',
    'admin.descripcion': 'Panel para preparar alumnos, claves, objetivo y herramientas recomendadas con acceso real de servidor.',
  ...
  en: {
    ...
    'admin.titulo': 'Teacher and super admin',
    'admin.descripcion': 'Panel for preparing students, credentials, goals, and recommended tools with real server access.',
