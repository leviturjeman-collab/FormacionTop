  ...
  return <div className="st-walkthrough">
    ...
    <div className="st-walkthrough-layout">
      ...
      <article className="st-step-workspace">
        ...
        <h1>{step.title}</h1>
        <section className="st-apply-context"><span>{project ? 'APLICADO A TU PROYECTO' : 'ACTIVIDAD SIN PROYECTO'}</span><p>{projectContext} {resource.projectApplication.toLowerCase()}</p></section>
