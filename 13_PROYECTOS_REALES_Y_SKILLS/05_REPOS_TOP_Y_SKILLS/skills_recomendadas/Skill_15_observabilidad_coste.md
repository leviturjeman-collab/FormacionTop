---
titulo: "Skill_15_observabilidad_coste"
tipo: "skill_recomendada"
...
tags: ["ai-academy", "skill_recomendada", "github", "repos", "skills"]
entregable: "skill instruction-only"
---
# Skill_15_observabilidad_coste

## Repos base

LiteLLM + logs + registro ejecucion

## Activacion

Usar cuando el alumno quiere controlar coste, tokens y fallback.

## Flujo

1. Confirmar objetivo del alumno.
2. Elegir la herramienta minima suficiente.
3. Definir entrada, salida, permisos y coste.
4. Crear una demo pequena.
5. Probar caso feliz.
6. Probar caso roto.
7. Documentar reparacion y limites.
...
# Desarrollo extenso premium - Skill 15 Observabilidad Coste
