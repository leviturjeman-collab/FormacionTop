---
titulo: "Skills recomendadas por objetivo"
tipo: "indice_skills"
...
tags: ["ai-academy", "indice_skills", "github", "repos", "skills"]
entregable: "indice de skills recomendadas"
---
# Skills recomendadas por objetivo

| Skill | Repos base | Activacion |
|---|---|---|
| [[Skill_01_router_multi_llm]] | LiteLLM + Open WebUI + Ollama | Usar cuando el alumno quiere comparar o enrutar entre varios LLMs. |
| [[Skill_02_video_pipeline]] | Remotion + FFmpeg + Whisper + TTS | Usar cuando el alumno quiere crear videos, subtitulos o piezas audiovisuales. |
| [[Skill_03_workflow_negocio]] | n8n + Activepieces | Usar cuando el alumno quiere automatizar captacion, soporte, informes o backoffice. |
| [[Skill_04_rag_documentos]] | LlamaIndex + Haystack + AnythingLLM | Usar cuando el alumno quiere consultar documentos con trazabilidad. |
| [[Skill_05_agente_visual]] | Dify + Flowise | Usar cuando el alumno quiere prototipar agentes sin escribir mucho codigo. |
| [[Skill_06_agente_codigo]] | Codex + OpenHands + Cline | Usar cuando el alumno quiere mantener o construir codigo con agente. |
| [[Skill_07_mcp_tools]] | MCP servers + awesome-mcp-servers | Usar cuando el alumno quiere conectar herramientas externas con permisos. |
| [[Skill_08_transcripcion]] | Whisper + whisper.cpp | Usar cuando el alumno quiere convertir audio/video en texto y subtitulos. |
| [[Skill_09_local_llm]] | Ollama + vLLM + Open WebUI | Usar cuando el alumno quiere privacidad, local-first o serving avanzado. |
| [[Skill_10_browser_agent]] | browser-use + Stagehand | Usar cuando el alumno quiere automatizar tareas web con limites claros. |
| [[Skill_11_prompting_profesional]] | Prompt Engineering Guide + OpenAI Cookbook | Usar cuando el alumno quiere mejorar instrucciones antes de anadir tecnologia. |
| [[Skill_12_agentes_beginners]] | Microsoft AI Agents + GenAI Agents | Usar cuando el alumno quiere aprender agentes paso a paso. |
| [[Skill_13_imagen_nodos]] | ComfyUI + Stable Diffusion WebUI | Usar cuando el alumno quiere imagen/video generativo por nodos. |
| [[Skill_14_voz_tts]] | Coqui TTS + Fish Speech | Usar cuando el alumno quiere voz sintetica para demos. |
| [[Skill_15_observabilidad_coste]] | LiteLLM + logs + registro ejecucion | Usar cuando el alumno quiere controlar coste, tokens y fallback. |
| [[Skill_16_validacion_json]] | JSON Schema + n8n + Python | Usar cuando el alumno quiere resolver fallos de formatos. |
| [[Skill_17_human_in_loop]] | n8n + LangGraph + aprobacion humana | Usar cuando el alumno quiere acciones sensibles con revision humana. |
| [[Skill_18_portfolio_demo]] | awesome-llm-apps + ottomator-agents | Usar cuando el alumno quiere buscar ideas para portfolio. |
| [[Skill_19_produccion_llm]] | vLLM + Haystack + Dify | Usar cuando el alumno quiere pasar de demo a sistema avanzado. |
| [[Skill_20_entrega_cliente]] | n8n + propuesta + documentacion tecnica | Usar cuando el alumno quiere entregar una automatizacion a cliente. |
...
Este archivo debe tratarse como una pieza de **skill recomendada** dentro de la formacion. Su funcion no es rellenar la boveda con contenido, sino ayudar a una persona real a producir un resultado verificable. En esta academia, una nota esta terminada cuando el alumno puede abrirla, entender el objetivo, preparar los materiales, ejecutar una practica, provocar un fallo, repararlo, guardar evidencia y defender lo aprendido con sus palabras.

El proposito concreto de esta pieza es **decidir que repos y herramientas usar segun objetivo, perfil y riesgo**. Eso significa que el profesor no debe usarla como lectura pasiva. Debe convertirla en actividad, demostracion, evaluacion o entregable. Si el alumno solo lee y asiente, todavia no hay aprendizaje profesional. Si el alumno produce una evidencia, detecta un limite y explica una decision, entonces la pieza empieza a cumplir su funcion.
