---
titulo: "Matriz por objetivo de alumno"
tipo: "matriz_decision"
nivel: "transversal"
fase: "construccion_portfolio"
estado: "investigacion_actualizada"
ultima_revision: "2026-08-18"
fuentes: ["https://github.com"]
tags: ["ai-academy", "matriz_decision", "github", "repos", "skills"]
entregable: "matriz de decision por objetivo"
---
# Matriz por objetivo de alumno

| Si el alumno quiere... | Primera opcion | Alternativas fuertes | Evitar al principio | Entregable recomendado |
|---|---|---|---|---|
| Automatizar procesos de negocio | [n8n](https://github.com/n8n-io/n8n) | [Activepieces](https://github.com/activepieces/activepieces), [Windmill](https://github.com/windmill-labs/windmill), [Huginn](https://github.com/huginn/huginn) | multiagentes complejos sin datos claros | workflow exportado + payload correcto/roto |
| Crear agentes visuales | [Dify](https://github.com/langgenius/dify) | [Flowise](https://github.com/FlowiseAI/Flowise), [LangGraph](https://github.com/langchain-ai/langgraph) | AutoGPT como primera practica | agente con caso feliz, ambiguo y roto |
| Trabajar con diferentes LLMs a la vez | [LiteLLM](https://github.com/BerriAI/litellm) | [Open WebUI](https://github.com/open-webui/open-webui), [Ollama](https://github.com/ollama/ollama), [vLLM](https://github.com/vllm-project/vllm) | hardcodear proveedor unico | router multi-LLM con logs y fallback |
| Crear videos | [Remotion](https://github.com/remotion-dev/remotion) | [FFmpeg](https://github.com/FFmpeg/FFmpeg), [Whisper](https://github.com/openai/whisper), [ComfyUI](https://github.com/Comfy-Org/ComfyUI), [TTS](https://github.com/coqui-ai/TTS) | prometer video IA completo sin pipeline | pipeline: guion -> voz -> subtitulos -> render |
| Transcribir y subtitular | [Whisper](https://github.com/openai/whisper) | [whisper.cpp](https://github.com/ggml-org/whisper.cpp), FFmpeg | subir datos sensibles sin consentimiento | SRT + resumen + checklist privacidad |
| Crear RAG/documentos | [LlamaIndex](https://github.com/run-llama/llama_index) | [Haystack](https://github.com/deepset-ai/haystack), [AnythingLLM](https://github.com/Mintplex-Labs/anything-llm), Dify | vector stores antes de entender chunking | demo RAG con eval de respuestas |
| Automatizar navegador | [browser-use](https://github.com/browser-use/browser-use) | [Stagehand](https://github.com/browserbase/stagehand) | scraping sin permisos ni limites | tarea navegador con logs y rollback |
| Aprender agentes desde cero | [microsoft/ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners) | [GenAI_Agents](https://github.com/NirDiamant/GenAI_Agents), awesome-llm-apps | saltar directo a produccion | cuaderno + mini agente defendido |
| Programar con agentes | [Codex](https://github.com/openai/codex) | [OpenHands](https://github.com/OpenHands/OpenHands), [Cline](https://github.com/cline/cline), [Continue](https://github.com/continuedev/continue) | aceptar cambios sin diff ni tests | issue + diff + prueba + defensa |
| Conectar tools via MCP | [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) | [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | tools con permisos amplios | mapa MCP + permisos minimos |

## Criterio profesional

La herramienta correcta es la que reduce friccion y aumenta evidencia. Si el alumno no puede explicar entrada, salida, permisos, coste y fallo probable, la herramienta es demasiado avanzada para esa fase.

<!-- DESARROLLO_EXTENSO_PREMIUM_2026_08_18 -->

# Desarrollo extenso premium - Matriz Por Objetivo
