# 04 Invoice OCR Review

## Objetivo

Automatizacion n8n para el area **finanzas**. Esta plantilla es didactica: debe importarse, probarse con payload ficticio y adaptarse antes de produccion.
...
# Implementacion detallada - 04 Invoice Ocr Review
