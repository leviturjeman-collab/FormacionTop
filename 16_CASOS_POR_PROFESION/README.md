...
Esta carpeta traduce la formacion tecnica a contextos profesionales reales. Es una pieza clave porque muchos alumnos no compran ni aprenden "herramientas"; compran transformacion aplicada a su trabajo. Una persona no quiere saber n8n por saber n8n. Quiere ahorrar horas, captar clientes, responder mejor, documentar procesos, crear contenido, analizar datos, vender servicios o construir productos. Por eso esta carpeta reorganiza la academia desde la pregunta que de verdad importa: "yo, con mi trabajo, que puedo hacer con todo esto?".

La regla de esta carpeta es que cada profesion debe tener tres capas: oportunidades, sistemas y entregables. Las oportunidades responden a que problemas se pueden resolver. Los sistemas explican como se conectan herramientas como ChatGPT, Claude, Gemini, Codex, Cursor, n8n, Ollama o Hermes. Los entregables convierten la teoria en algo que el alumno puede mostrar: una auditoria, una automatizacion, un asistente, una presentacion, una base de conocimiento, un workflow, una plantilla, un panel o un caso de estudio.

## Profesiones y contextos incluidos

- [[Freelancers_y_consultores]]
- [[Agencias_y_estudios]]
- [[Negocios_locales]]
- [[Ecommerce_y_ventas_online]]
- [[Creadores_de_contenido]]
- [[Programadores_y_equipos_tecnicos]]
- [[Educacion_y_formadores]]
- [[Operaciones_y_backoffice]]

## Como usar esta carpeta

Primero, el alumno identifica su contexto. Si no tiene una profesion clara, elige el caso que mas se parece a su realidad. Despues lee el archivo correspondiente y marca tres problemas repetitivos de su trabajo. Luego convierte uno en proyecto pequeno. La secuencia recomendada es: problema, datos, herramienta, flujo, salida, revision humana y medicion.

Ejemplo: una agencia no empieza creando "un agente IA". Empieza detectando que pierde tiempo redactando propuestas. El sistema podria ser: formulario de discovery, resumen con ChatGPT o Claude, plantilla de propuesta, n8n para crear documento, revision humana y envio. Si el sistema funciona, se convierte en servicio interno o producto para clientes.

## Criterio AAAA+

Un caso por profesion es AAAA+ si cumple estos requisitos: usa lenguaje del oficio, no lenguaje de proveedor; identifica dolores reales; propone flujos accionables; separa herramientas necesarias de herramientas opcionales; incluye un proyecto basico, uno intermedio y uno avanzado; define entregables; incluye errores frecuentes; y deja una ruta para vender, documentar o defender el resultado.

La formacion debe evitar prometer "automatiza todo tu negocio". Esa frase suena bien, pero no ensena. Lo profesional es decir: automatiza este proceso, con esta entrada, esta decision, este control humano y esta metrica. Si el alumno aprende esa forma de pensar, podra aplicar IA a cualquier oficio.


---

# Capa de desarrollo AAAA+ aplicada a README

## Para que sirve este archivo dentro de la formacion

Este archivo no debe leerse como una nota aislada. Su funcion dentro de la academia es convertir el tema README en una pieza util para aprender, aplicar, construir, documentar y defender trabajo real. La pregunta que debe guiar su uso es sencilla: que puede hacer el alumno despues de leerlo que antes no podia hacer con claridad. Si la respuesta no se puede convertir en una accion observable, una practica, una plantilla, una decision de herramientas o un entregable, el archivo debe ampliarse o conectarse con otro material de la boveda.
...
Una clase basada en README no deberia terminar con "lo hemos visto". Debe terminar con algo que el alumno pueda guardar en Obsidian: una checklist, una plantilla, un prompt, un workflow, un mini informe, una rubrica, un mapa de decision o una pieza de portfolio. Ese artefacto es la prueba de aprendizaje.

## Practica recomendada

La practica recomendada consiste en tomar un problema pequeÃƒÂ±o y usar README para resolverlo de forma limitada. Primero se define el objetivo. Despues se escribe el contexto. Luego se decide que herramienta o metodo se usara. A continuacion se construye una primera version. Despues se provoca un fallo. Finalmente se documenta la reparacion.
...
Para convertir README en entregable, aÃƒÂ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒÂ±ade alcance y mantenimiento. Si es para portfolio, aÃƒÂ±ade demo y caso de estudio. Si es para clase, aÃƒÂ±ade practica y rubrica. Si es para uso interno, aÃƒÂ±ade responsable y frecuencia de revision.
...
Usar **CASOS POR PROFESION** para producir el entregable definido en la metadata: **plan de aplicacion profesional**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **CASOS POR PROFESION**.
