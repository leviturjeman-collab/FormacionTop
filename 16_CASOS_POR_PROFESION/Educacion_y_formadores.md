...
---
# Educacion y formadores

Para educadores, la IA permite diseÃ±ar curriculos, crear lecciones, adaptar niveles, generar ejercicios, evaluar respuestas, preparar rubricas, convertir contenido en presentaciones y personalizar aprendizaje. El riesgo es producir material largo pero sin pedagogia. Por eso esta ruta usa el metodo `CHECK -> DO -> BREAK -> FIX -> EXPLAIN`.

## Basico

En basico, el formador usa IA para estructurar clases, definir objetivos, crear ejemplos, explicar conceptos en varios niveles y preparar preguntas. Debe verificar fuentes y evitar explicaciones demasiado abstractas.

## Intermedio

En intermedio, crea laboratorios, casos, evaluaciones, bancos de prompts y materiales por perfil. n8n puede automatizar feedback, registro de tareas y generacion de certificados internos. Gemini puede ayudar con material multimodal. Codex o Cursor pueden construir herramientas educativas.

## Avanzado

En avanzado, se diseÃ±a una academia completa: rutas 30/60/90, proyectos, rubricas, defensa final, portfolio, sistema de actualizacion de fuentes y productizacion. La IA ayuda a mantener la estructura, pero el criterio docente define progresion, dificultad y evidencia.

## Proyecto recomendado

Crear una "clase AAAA+" sobre una herramienta. Debe incluir objetivo, modelo mental, practica, error provocado, reparacion, evaluacion y transferencia a trabajo real. BREAK: explicar demasiada teoria sin practica. FIX: convertir conceptos en acciones observables.

## Entregables

- Plantilla de leccion.
- Laboratorio.
- Rubrica.
- Presentacion.
- Guia del profesor.
...
Una clase basada en Educacion y formadores no deberia terminar con "lo hemos visto". Debe terminar con algo que el alumno pueda guardar en Obsidian: una checklist, una plantilla, un prompt, un workflow, un mini informe, una rubrica, un mapa de decision o una pieza de portfolio. Ese artefacto es la prueba de aprendizaje.

## Practica recomendada

La practica recomendada consiste en tomar un problema pequeÃƒÂ±o y usar Educacion y formadores para resolverlo de forma limitada. Primero se define el objetivo. Despues se escribe el contexto. Luego se decide que herramienta o metodo se usara. A continuacion se construye una primera version. Despues se provoca un fallo. Finalmente se documenta la reparacion.
...
Para convertir Educacion y formadores en entregable, aÃƒÂ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒÂ±ade alcance y mantenimiento. Si es para portfolio, aÃƒÂ±ade demo y caso de estudio. Si es para clase, aÃƒÂ±ade practica y rubrica. Si es para uso interno, aÃƒÂ±ade responsable y frecuencia de revision.
...
Usar **Educacion y formadores** para producir el entregable definido en la metadata: **plan de aplicacion profesional**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Educacion y formadores**.
