---
titulo: "Roadmap 30 dias Fundamentos y primeras practicas"
...
tags: ["ai-academy", "guia_pedagogica", "basico", "aprendizaje"]
entregable: "guia de clase o ruta de aprendizaje"
---
# Roadmap 30 dias - Fundamentos y primeras practicas

El objetivo de los primeros 30 dias es que el alumno deje de usar IA como una caja de texto y empiece a trabajar con metodo. No tiene que dominar todas las herramientas. Tiene que entender vocabulario, crear prompts utiles, leer outputs criticamente, construir workflows sencillos, revisar codigo o documentos y explicar que ha hecho.

## Semana 1 - Modelo mental

Estudiar IA generativa, prompts, contexto, instrucciones, outputs, tokens, alucinaciones, fuentes y verificacion. Practica: convertir una idea desordenada en briefing claro. Entregable: una nota en Obsidian con objetivo, publico, contexto, restricciones y salida esperada.

## Semana 2 - ChatGPT, Claude y Gemini

Comparar tres usos: redaccion, razonamiento y extraccion estructurada. Practica: pedir una respuesta libre, una tabla y un JSON. BREAK: pedir informacion actual sin fuentes. FIX: exigir fuentes, fecha y dudas.

## Semana 3 - n8n basico

Crear un workflow manual y uno con webhook. Practica: recibir datos, validar campos y devolver respuesta. Entregable: captura o descripcion de ejecucion, inputs y outputs. BREAK: campo inexistente. FIX: validacion previa.

## Semana 4 - Codigo asistido y documentacion

Usar Codex, Cursor o Claude Code para entender un proyecto pequeño. Practica: pedir explicacion de archivos y hacer un cambio simple con revision de diff. Entregable: nota con cambio, pruebas y riesgo.

## Evaluacion

El alumno aprueba si puede explicar una herramienta en 60 segundos, construir una practica pequeña, romperla, repararla y documentarla. No se exige velocidad; se exige claridad.


---

# Capa de desarrollo AAAA+ aplicada a Roadmap 30 dias Fundamentos y primeras practicas

## Para que sirve este archivo dentro de la formacion

Este archivo no debe leerse como una nota aislada. Su funcion dentro de la academia es convertir el tema Roadmap 30 dias Fundamentos y primeras practicas en una pieza util para aprender, aplicar, construir, documentar y defender trabajo real. La pregunta que debe guiar su uso es sencilla: que puede hacer el alumno despues de leerlo que antes no podia hacer con claridad. Si la respuesta no se puede convertir en una accion observable, una practica, una plantilla, una decision de herramientas o un entregable, el archivo debe ampliarse o conectarse con otro material de la boveda.
...
Una clase basada en Roadmap 30 dias Fundamentos y primeras practicas no deberia terminar con "lo hemos visto". Debe terminar con algo que el alumno pueda guardar en Obsidian: una checklist, una plantilla, un prompt, un workflow, un mini informe, una rubrica, un mapa de decision o una pieza de portfolio. Ese artefacto es la prueba de aprendizaje.

## Practica recomendada

La practica recomendada consiste en tomar un problema pequeÃƒ±o y usar Roadmap 30 dias Fundamentos y primeras practicas para resolverlo de forma limitada. Primero se define el objetivo. Despues se escribe el contexto. Luego se decide que herramienta o metodo se usara. A continuacion se construye una primera version. Despues se provoca un fallo. Finalmente se documenta la reparacion.
...
Para convertir Roadmap 30 dias Fundamentos y primeras practicas en entregable, aÃƒ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒ±ade alcance y mantenimiento. Si es para portfolio, aÃƒ±ade demo y caso de estudio. Si es para clase, aÃƒ±ade practica y rubrica. Si es para uso interno, aÃƒ±ade responsable y frecuencia de revision.
...
Usar **Roadmap 30 dias Fundamentos y primeras practicas** para producir el entregable definido en la metadata: **guia de clase o ruta de aprendizaje**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Roadmap 30 dias Fundamentos y primeras practicas**.
