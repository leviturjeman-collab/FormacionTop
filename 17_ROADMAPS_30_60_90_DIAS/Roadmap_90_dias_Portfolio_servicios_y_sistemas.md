---
titulo: "Roadmap 90 dias Portfolio servicios y sistemas"
...
tags: ["ai-academy", "guia_pedagogica", "avanzado", "aprendizaje"]
entregable: "guia de clase o ruta de aprendizaje"
---
# Roadmap 90 dias - Portfolio, servicios y sistemas

El objetivo de los 90 dias es convertir aprendizaje en posicionamiento profesional. El alumno debe salir con un portfolio, una demo, una propuesta de servicio, un caso de estudio y un capstone final. Aqui la formacion deja de ser "he aprendido herramientas" y se convierte en "puedo resolver problemas reales".

## Dias 1-30

Repaso de fundamentos, prompts, IA comparada, n8n basico, codigo asistido y Obsidian como base de conocimiento. Entregables: notas limpias, primer laboratorio y mapa personal de herramientas.

## Dias 31-60

Construccion de proyectos: workflow n8n, asistente de investigacion, generador de propuestas o mini herramienta. Entregables: tres proyectos documentados, cada uno con problema, solucion, arquitectura, errores y resultado.

## Dias 61-90

Productizacion: elegir nicho, empaquetar oferta, crear demo, preparar propuesta, definir precio, crear caso de estudio y practicar defensa oral. Entregable final: portfolio con minimo tres piezas y un capstone integrador.

## Evaluacion

La evaluacion final tiene tres partes: demo funcional, documento de arquitectura y defensa. La defensa debe responder: que problema resuelve, por que elegiste esas herramientas, que riesgos existen, como se mantiene y como se venderia.


---

# Capa de desarrollo AAAA+ aplicada a Roadmap 90 dias Portfolio servicios y sistemas

## Para que sirve este archivo dentro de la formacion

Este archivo no debe leerse como una nota aislada. Su funcion dentro de la academia es convertir el tema Roadmap 90 dias Portfolio servicios y sistemas en una pieza util para aprender, aplicar, construir, documentar y defender trabajo real. La pregunta que debe guiar su uso es sencilla: que puede hacer el alumno despues de leerlo que antes no podia hacer con claridad. Si la respuesta no se puede convertir en una accion observable, una practica, una plantilla, una decision de herramientas o un entregable, el archivo debe ampliarse o conectarse con otro material de la boveda.
...
Una clase basada en Roadmap 90 dias Portfolio servicios y sistemas no deberia terminar con "lo hemos visto". Debe terminar con algo que el alumno pueda guardar en Obsidian: una checklist, una plantilla, un prompt, un workflow, un mini informe, una rubrica, un mapa de decision o una pieza de portfolio. Ese artefacto es la prueba de aprendizaje.

## Practica recomendada

La practica recomendada consiste en tomar un problema pequeÃƒÂ±o y usar Roadmap 90 dias Portfolio servicios y sistemas para resolverlo de forma limitada. Primero se define el objetivo. Despues se escribe el contexto. Luego se decide que herramienta o metodo se usara. A continuacion se construye una primera version. Despues se provoca un fallo. Finalmente se documenta la reparacion.
...
Para convertir Roadmap 90 dias Portfolio servicios y sistemas en entregable, aÃƒÂ±ade portada, objetivo, contexto, pasos, resultado, limites, riesgos, checklist y siguiente accion. Si es para cliente, aÃƒÂ±ade alcance y mantenimiento. Si es para portfolio, aÃƒÂ±ade demo y caso de estudio. Si es para clase, aÃƒÂ±ade practica y rubrica. Si es para uso interno, aÃƒÂ±ade responsable y frecuencia de revision.
...
Usar **Roadmap 90 dias Portfolio servicios y sistemas** para producir el entregable definido en la metadata: **guia de clase o ruta de aprendizaje**. El archivo debe ayudar a entender, aplicar, verificar y explicar el tema sin depender de memoria externa.
...
- Si se detecta informacion generica, convertirla en ejemplo especifico de **Roadmap 90 dias Portfolio servicios y sistemas**.
