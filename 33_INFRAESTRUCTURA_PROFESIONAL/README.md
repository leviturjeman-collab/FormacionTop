---
titulo: "Infraestructura profesional para proyectos IA"
tipo: "indice_infraestructura"
nivel: "transversal"
fase: "produccion"
estado: "investigacion_actualizada"
ultima_revision: "2026-08-18"
fuentes: ["https://docs.docker.com/", "https://supabase.com/docs", "https://neon.com/docs", "https://docs.github.com/actions", "https://playwright.dev/docs/intro", "https://docs.sentry.io/", "https://posthog.com/docs", "https://qdrant.tech/documentation/", "https://developers.cloudflare.com/workers/wrangler/", "https://fly.io/docs/flyctl/", "https://docs.railway.com/cli", "https://render.com/docs/cli"]
tags: ["ai-academy", "infraestructura", "produccion", "terminal"]
entregable: "mapa de infraestructura profesional"
---
# Infraestructura profesional para proyectos IA

Esta carpeta convierte la formacion en una academia ejecutable: bases de datos, Docker, APIs, seguridad, observabilidad, CI/CD, testing, vector DBs, deploy, MCP, arquitecturas y mini repos clonables.

## Guias

| Guia | Uso | Entregable |
|---|---|---|
| [[01_Docker_Databases_APIs]] | Docker, Supabase, Neon, Postgres, APIs y cURL | stack local + prueba API |
| [[02_Seguridad_Auth_Secrets_Env]] | API keys, OAuth, scopes, RBAC, webhooks y `.env` | checklist de seguridad |
| [[03_CICD_Testing_Observabilidad]] | GitHub Actions, Playwright, Sentry, PostHog y logs | workflow + test + evento |
| [[04_VectorDB_RAG_MCP]] | pgvector, Qdrant, Chroma, RAG y MCP real | demo RAG + mapa tools |
| [[05_Deploy_Plataformas]] | Vercel, Cloudflare, Railway, Render, Fly, Supabase y VPS | matriz de deploy |
| [[06_Arquitecturas_y_Mini_Repos]] | diagramas, repos clonables y estructura profesional | repos base + diagramas |

## Regla de calidad

Un proyecto no pasa a portfolio si no tiene setup, variables, prueba, fallo provocado, rollback y defensa.
...
Este archivo debe tratarse como una pieza de **guia de infraestructura** dentro de la formacion. Su funcion no es rellenar la boveda con contenido, sino ayudar a una persona real a producir un resultado verificable. En esta academia, una nota esta terminada cuando el alumno puede abrirla, entender el objetivo, preparar los materiales, ejecutar una practica, provocar un fallo, repararlo, guardar evidencia y defender lo aprendido con sus palabras.

El proposito concreto de esta pieza es **preparar proyectos para ejecucion, despliegue, observabilidad, seguridad y mantenimiento**. Eso significa que el profesor no debe usarla como lectura pasiva. Debe convertirla en actividad, demostracion, evaluacion o entregable. Si el alumno solo lee y asiente, todavia no hay aprendizaje profesional. Si el alumno produce una evidencia, detecta un limite y explica una decision, entonces la pieza empieza a cumplir su funcion.
