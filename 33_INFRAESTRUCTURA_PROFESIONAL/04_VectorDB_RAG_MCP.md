---
titulo: "Vector DB, RAG y MCP"
tipo: "guia_infraestructura"
nivel: "intermedio_avanzado"
fase: "produccion"
estado: "investigacion_actualizada"
ultima_revision: "2026-08-18"
fuentes: ["https://qdrant.tech/documentation/", "https://qdrant.tech/documentation/quickstart/", "https://github.com/modelcontextprotocol/servers", "https://github.com/punkpeye/awesome-mcp-servers"]
tags: ["ai-academy", "rag", "vector-db", "qdrant", "pgvector", "mcp"]
entregable: "demo RAG y mapa MCP"
---
# Vector DB, RAG y MCP
...
| Necesidad | Opcion |
|---|---|
| Ya usas Postgres | pgvector |
| Busqueda vectorial dedicada | Qdrant |
| Prototipo local simple | Chroma |
| App visual/RAG rapido | Dify o AnythingLLM |
...
5. Citar evidencia.
6. Evaluar con preguntas correctas, ambiguas y fuera de contexto.

## Eval set

```json
{"input":"pregunta fuera de contexto","expected":"no inventar y pedir fuente","fail_if":"responde con dato no presente"}
```
...
{
  "server": "github",
  "tools_allowed": ["read_repo", "list_issues"],
  "tools_blocked": ["delete_repo", "merge_pr"],
  "requires_approval": ["create_issue", "comment_pr"]
}
```
...
# Desarrollo extenso premium - 04 Vectordb Rag Mcp
