---
titulo: "Docker, bases de datos y APIs"
tipo: "guia_infraestructura"
nivel: "intermedio"
fase: "produccion"
estado: "investigacion_actualizada"
ultima_revision: "2026-08-18"
fuentes: ["https://docs.docker.com/", "https://docs.docker.com/compose/", "https://supabase.com/docs", "https://neon.com/docs/connect/connect-from-any-app"]
tags: ["ai-academy", "docker", "postgres", "supabase", "neon", "api"]
entregable: "stack local y prueba API"
---
# Docker, bases de datos y APIs
...
Supabase local necesita Docker o runtime compatible.
...
Neon usa connection strings Postgres estandar. Guardar la URL en `DATABASE_URL`.
...
curl -X POST https://api.example.com/leads \
  ...
  -d '{"email":"demo@example.com","need":"automatizar leads"}'
```
...
# Desarrollo extenso premium - 01 Docker Databases Apis
