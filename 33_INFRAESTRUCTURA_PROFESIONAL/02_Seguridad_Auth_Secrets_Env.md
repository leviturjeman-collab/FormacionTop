---
titulo: "Seguridad, auth, secrets y env"
tipo: "guia_seguridad"
nivel: "intermedio_avanzado"
fase: "produccion"
estado: "investigacion_actualizada"
ultima_revision: "2026-08-18"
fuentes: ["https://vercel.com/docs/environment-variables", "https://docs.github.com/actions/security-guides/using-secrets-in-github-actions", "https://supabase.com/docs"]
tags: ["ai-academy", "seguridad", "auth", "secrets", "env"]
entregable: "checklist de seguridad"
---
# Seguridad, auth, secrets y env

## Conceptos

- API key: identifica una app o usuario tecnico.
- Bearer token: se envia en `Authorization`.
- OAuth: delega acceso con scopes.
- RBAC: permisos por rol.
- Webhook firmado: valida que el evento viene del proveedor correcto.
- Secret rotation: cambiar claves cuando se exponen o caducan.
...
SENTRY_AUTH_TOKEN=replace_me_server_only
STRIPE_SECRET_KEY=replace_me_server_only
STRIPE_WEBHOOK_SECRET=replace_me_server_only
```
...
- `SERVICE_ROLE`, `SECRET`, `TOKEN`, `DATABASE_URL` y `PRIVATE` son servidor/CI.
- Si una clave se sube a GitHub, se rota.
